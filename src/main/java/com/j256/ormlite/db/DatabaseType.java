...
public interface DatabaseType {
	...
	/**
	 * Takes a {@link ReflectiveFieldType} and appends the SQL necessary to create the field to the string builder. The field may
	...
	/**
	 * Takes a {@link ReflectiveFieldType} and adds the necessary statements to the before and after lists necessary so that the

...
public class In extends BaseComparison {
	...
	public In(String columnName, DbField dbField, Iterable<?> objects, boolean in) throws SQLException {
		super(columnName, dbField, null, true);
		this.objects = objects;
		this.in = in;
	}

	public In(String columnName, DbField dbField, Object[] objects, boolean in) throws SQLException {
		super(columnName, dbField, null, true);
	...
	public void appendValue(DatabaseType databaseType, StringBuilder sb, List<ArgumentHolder> columnArgList)
		...
		for (Object value : objects) {
			...
			super.appendArgOrValue(databaseType, dbField, sb, columnArgList, value);
		}
		sb.append(") ");
	}
}
